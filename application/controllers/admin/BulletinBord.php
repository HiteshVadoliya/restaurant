...
class BulletinBord extends BaseController
{
    public function __construct()
    {
        parent::__construct();
        $this->isLoggedIn();
        $this->table = "bulletin_bord";   
        $this->id = "id";  
        $this->MainTitle = " Bulletin Bord";
        $this->folder = "bulletinbord/";
        $this->Controller = "BulletinBord";
        $this->url = "bulletinbord";
        $this->assets = IMG_BULLETIN_BORD; 
    }
