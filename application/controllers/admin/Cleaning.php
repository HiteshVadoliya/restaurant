...
class Cleaning extends BaseController
{
    public function __construct()
    {
        ...
        $this->table = "cleaning";   
        $this->id = "id";  
        $this->MainTitle = " Cleaning List";
        $this->folder = "cleaning/";
        $this->Controller = "Cleaning";
        $this->url = "cleaning";
        $this->assets = ''; 
    }
    ...
    public function showView($id = '') {
        ...
        if($this->isAdmin() == TRUE) { $this->loadThis(); } else
        {
            if($id!='') {
                $data['type'] = "View";
                $data['cleaning_heading'] = $this->HWT->get_result('cleaning_heading',"*",array("isDelete"=>0));
                $data['shift_type'] = $id;
            } else {                
    ...
    public function ajax_list()
    {
        ...
        $join = $tbl = array($this->table, "cleaning_heading");
