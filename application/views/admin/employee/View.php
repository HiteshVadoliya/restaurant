<div class="content-wrapper">
   <section class="content">
      <div class="row">
         ...
         <section class="content">
            <?php 
            if( $view['user_status'] == '0'  ) {
            ?>
            <!-- Default box -->
            <div class="box ">
               <div class="box-header with-border">
                  <h3 class="box-title">Active and Send Email</h3>
               ...
               <div class="box-body" style="">
                  <div class="col-md-6">
                     <form enctype="multipart/form-data" role="form" id="frm" name="frm" action="<?php echo ADMIN_LINK; ?>/employee/send_an_active" method="post" role="form">
                     
                         <div class="box-body">
                              <div class="form-group">
                                  <label for="title">Password</label>
                                  <input type="text" class="form-control required" value="<?php echo random_string('alnum',15); ?>" id="password" name="password" maxlength="128" >
                              </div>
                              <input type="hidden" name="roleId" value="<?php echo 5; ?>" >
                              <input type="hidden" name="userId" value="<?= $view['userId']; ?>" >
                         </div><!-- /.box-body -->
                         <div class="box-footer">
                             <input type="submit" class="btn btn-primary" value="Active and Send Mail" />
                         </div>                         
                     </form>
                  </div>
               </div>
