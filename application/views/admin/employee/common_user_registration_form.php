  ...
  <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <select name="previous_permission_to_contact" id="previous_permission_to_contact" class="form-control">
                ...
                <option value="1" <?php if(isset($edit) && $edit['previous_permission_to_contact']=='1' ) { echo "selected"; } ?> >Yes</option>
                <option value="0" <?php if(isset($edit) && $edit['previous_permission_to_contact']=='0' ) { echo "selected"; } ?> >No</option>                          
            </select>
        </div>
